/**
  @page STemWin   STM32F769I-DISCO STemWin Demonstration Firmware
 
  @verbatim
  ******************************************************************************
  * @file    Demonstrations/STemWin/readme.txt 
  * @author  MCD Application Team
  * @brief   Description of STM32F769I-DISCO Demonstration
  ******************************************************************************
  * @attention
  *
...
The STM32 F7 demonstration is running on STM32F769I discovery boards 

  - 'STM32CubeDemo_STM32769I-DISCO_VX.Y.Z.hex': is a standalone demo based on StemWin and which source code 
...
@note The VideoPlayer module is not supported when VNC server module is used since 
      ...
      the remote machine.
@note For STM32CubeDemo_STM32769I-DISCO_VX.Y.Z.hex binary, it is recommended to use an USB Key 
      containing only set of media files available under "Utilities/Media" folder.
...
Demonstration, STemWin, FreeRTOS, RTOS, Middleware, Audio record, wav, Video Player, avi, MP3, Audio player, Graphic,
Game, Reversi, System, CPU, VNC, SAI, QUADSPI, USB, Microphone 

@par Hardware and Software environment

  - This demonstration runs on STM32F769xx devices.    
  - This demonstration has been tested with STM32F769I-DISCO RevB discovery board.
   
@par How to use it ? 

In order to program the demonstration you must do the following:
1- Open STM32CubeProgrammer and click on connect
2- Go to external loaders menu then select MX25L512G_STM32F769I-DISCO to program external QSPI memory
3- From Erasing and programming Menu browse to select the STM32CubeDemo_STM32769I-DISCO_VX.Y.Z.hex file from build folder then click on start programming
4- copy the audio and video files provided under "Utilities/Media/Audio" and "Utilities/Media/Video" folders in the USB key
5- Plug an USB micro A-Male to A-Female cable on CN15 connector
...
      Please refer to the AN4838 "Introduction to memory protection unit management on STM32 MCUs"
