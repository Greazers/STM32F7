...
Note that the following user files may need to be updated:
  LCDConf_stm32f769i_eval.c
  GUIConf_stm32f769i_eval.c
...
@par Directory contents 
  ...
  - STemWin/STemWin_HelloWorld/STemWin/Target/GUIConf.h                  Header for GUIConf_stm32f769i_eval.c
  - STemWin/STemWin_HelloWorld/STemWin/Target/LCDConf.h                  Header for LCDConf_stm32f769i_eval.c
  ...
  - STemWin/STemWin_HelloWorld/STemWin/Target/GUIConf_stm32f769i_eval.c  Display controller initialization
  - STemWin/STemWin_HelloWorld/STemWin/Target/LCDConf_stm32f769i_eval.c  Configuration file for the GUI library
...
@par Hardware and Software environment 
  ...
  - This example has been tested with STM32F769I-EVAL  evaluation board and can be
